...
public class CaseStudy {
    ...
    public CaseStudy(String sector, String vertical, String specialization, String caseStudyName, List<String> learningObjectives, List<String> technologies, String difficulty, int duration, int numOfDevs, String scenarioDescription) {
        this.sector = sector;
